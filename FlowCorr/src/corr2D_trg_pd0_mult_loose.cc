...
{
   if(isPrompt){
      if(event->Pt(icand)<4.) return event->Mva(icand) > 0.54;
      else if (event->Pt(icand) <6. && event->Pt(icand)>=4.) return event->Mva(icand) > 0.42;
      else if (event->Pt(icand) <8. && event->Pt(icand)>=6.) return event->Mva(icand) > 0.24;
   } else{
