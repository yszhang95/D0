...
{
   if(isPrompt){
      if(event->Pt(icand)<4.) return event->Mva(icand) > (0.58+0.05);
      else if (event->Pt(icand) <6. && event->Pt(icand)>=4.) return event->Mva(icand) > (0.46+0.05);
      else if (event->Pt(icand) <8. && event->Pt(icand)>=6.) return event->Mva(icand) > (0.28+0.05);
   } else{
