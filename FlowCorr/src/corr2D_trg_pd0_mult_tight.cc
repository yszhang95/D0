...
{
   if(isPrompt){
      if(event->Pt(icand)<4.) return event->Mva(icand) > 0.62;
      else if (event->Pt(icand) <6. && event->Pt(icand)>=4.) return event->Mva(icand) > 0.5;
      else if (event->Pt(icand) <8. && event->Pt(icand)>=6.) return event->Mva(icand) > 0.32;
   } else{
