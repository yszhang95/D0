...
void massfitvn_combine_pd0(const char* input_mc = "MC/hMC_mass_d0ana_y2.0.root",
      const char* input_data = "data/corr2D_d0ana_y2.0.root_v2.root",
      const char* output = "data/v2vspt_d0_HM185_250_y2.0_d0ana.root"
      )
{
   gStyle->SetOptStat(0);
   ...
   cout << "test" << endl;
        ...
        TH1D* h_data = (TH1D*)file1->Get(Form("hmass_pt%d_dca0",i));
        ...
        TGraphErrors* vn_data = (TGraphErrors*)file1->Get(Form("g_v2_DCA_pt%d_dca0",i));
...
//        leg1->AddEntry(f3,"Combinatorial","l");
    ...
    for(int i=0;i<8;i++)
    {
     //   c[i]->Print(Form("plots/D0_mass_vnfit_combine_pt%d.pdf",i));
        c[i]->Print(Form("plots/d0ana/D0_mass_vnfit_combine_pt%d.png",i));
    }
    ...
    TGraphErrors* v2plot = new TGraphErrors(8,pt,v2,0,v2e);
