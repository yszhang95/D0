...
public:
   ...
   virtual Float_t   PtTrk(const unsigned int icand)        const {return (float)pTTRK[icand];}
   virtual Float_t   EtaTrk(const unsigned int icand)       const {return (float)etaTRK[icand];}
   virtual Float_t   PhiTrk(const unsigned int icand)       const {return (float)phiTRK[icand];}
   virtual Float_t   WeightTrk(const unsigned int icand)    const {return (float)weightTRK[icand];}
