      ...
      const float yMin =0., const float yMax =0.)
{
   ...
   gInterpreter->ProcessLine(Form("proj1D_HM_NPD0_Process_new(\"%s\", \"%s\", \"%s\", \"%s\", \"%s\", %f, %f, %f, %f)", 
            "../data/corr2D_trg_npd0_PAHM185-250_pT2.0-8.0_y-1.0-1.0_new_binning.root_loose",
            ...
            "../data/corr2D_trg_npd0_MB0-185_pT2.0-8.0_y-1.0-1.0_new_loose.root", "../data/PAMB_ref.root",
            2.0, 8.0, -1.0, 1.0));
