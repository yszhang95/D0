...
void massfitvn_combine_npd0_v2vspt_new(
      )
{
      const char* input_mc = "";
      ...
      gInterpreter->ProcessLine(".L massfitJets_combine_npd0_v2vspt_process_new.C");
      gInterpreter->ProcessLine(".L massfitJets_low_combine_npd0_v2vspt_process_new.C");
      gInterpreter->ProcessLine(".L fitNass_npd0.C");

      gInterpreter->ProcessLine(
            Form("massfitVn_combine_npd0_v2vspt_process_new(\"%s\", \"%s\", \"%s\", \"%s\", %f, %f, %f, %d)",
            "../MC/npd0ana1_hists_mass_pT2.0-8.0_y-1.0-1.0_ptbin2.root",
            "../data/corr2D_trg_npd0_PAHM185-250_pT2.0-8.0_y-1.0-1.0_new_binning.root_raw.root",
      ...
      gInterpreter->ProcessLine(
            Form("fitNass_npd0(\"%s\", \"%s\")", "../data/corr2D_trg_npd0_PAHM185-250_pT2.0-8.0_y-1.0-1.0_new_binning.root_raw.root", "../data/nass_npd0_pT2.0-8.0_y-1.0-1.0_new_binning.root")
            );
