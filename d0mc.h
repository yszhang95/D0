...
// Fixed size dimensions of array or collections stored in the TChain if any.
   ...
   virtual Bool_t  IsSwap() const {return isSwap;}
   virtual Int_t   IdMom_Reco() const {return idmom_reco;}
   virtual Bool_t  MatchGEN() const {return matchGEN;}
};
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/storage1/users/wl33/D0Trees/MC/Merge_NonPromptD0_pPbMC_MVATree_signal_combined_BDT_v1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/storage1/users/wl33/D0Trees/MC/Merge_NonPromptD0_pPbMC_MVATree_signal_combined_BDT_v1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/storage1/users/wl33/D0Trees/MC/Merge_NonPromptD0_pPbMC_MVATree_signal_combined_BDT_v1.root:/d0ana_mc");
      dir->GetObject("d0mc",tree);
...
Int_t d0mc::GetEntry(Long64_t entry)
{
...
Long64_t d0mc::LoadTree(Long64_t entry)
{
